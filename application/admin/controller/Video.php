...
class Video extends Admin
{
    ...
    private function data($page =1,$limit = 10,$type=''){
        //获取信息
        $result = VideoModel::getEntityPage($page,$limit,$type);

        //获取总数
        $total = VideoModel::getCount();
    ...
    public function edit($id = 0){
        ...
        if(is_numeric($id)){
            ...
            $result = VideoModel::getEntityById($id);
            $catagorys = CatagoryModel::getEntitys();
    ...
    public function save_data(){
        ...
        $result =  $this->validate(input('post.'),'Video.insert');
    ...
    public function del_data(){
        ...
        $result =  $this->validate(input('post.id/a'),'Video.del');
